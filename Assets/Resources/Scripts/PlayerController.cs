...
public class PlayerController : MonoBehaviour
{
	...
	public void Move()
	{
		if (direction.magnitude > 0.1f)
		{
			...
			if (isWalking)
			{ rigidBodyComp.velocity = movementSpeed * moveDirection; }
			else
			{ rigidBodyComp.velocity = movementSpeed * speedMultiplier * moveDirection; }
		}
		else
		{
...
#pragma warning disable IDE0060 // Удалите неиспользуемый параметр
	...
	{
		rigidBodyComp.AddForce(0f, 15f, 0f, ForceMode.Impulse);
	}
